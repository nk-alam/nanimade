        ...
        >
          <div>
            ...
            <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">
              Join NaniMade Family
            </h2>
            <p className="mt-2 text-center text-sm text-gray-600">
              Create your account to start shopping authentic pickles
            </p>
          </div>
          ...
          <div className="mt-8 space-y-6">
            ...
            <button
              ...
              className="group relative w-full flex justify-center py-3 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors"
            >
